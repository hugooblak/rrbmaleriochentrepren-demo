<?php
/**
 * RRB måleri & entreprenad AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "RRB måleri & entreprenad AB Leads" plugin, so leads survive a theme change.
 *
 ...
 * Patterns read these through rr_lead() so one demo can be rebuilt for any firm.
 */
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'rrbmaleriochentrepren', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'rrbmaleriochentrepren' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'rrbmaleriochentrepren' ) ) );

		register_block_pattern_category( 'rrbmaleriochentrepren-sections', array( 'label' => __( 'RRB måleri & entreprenad AB sections', 'rrbmaleriochentrepren' ) ) );
		register_block_pattern_category( 'rrbmaleriochentrepren-pages', array( 'label' => __( 'RRB måleri & entreprenad AB page layouts', 'rrbmaleriochentrepren' ) ) );
	}
);
