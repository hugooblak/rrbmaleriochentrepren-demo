<?php
/**
 * Demo site setup for RRB måleri & entreprenad AB.
 *
 ...
 *
 * @package RRB måleri & entreprenad AB
 */
 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'RRB måleri & entreprenad AB' );
...
$home = nps_page(
	...
	nps_pattern( 'rrbmaleriochentrepren/page-home' ),
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'rrbmaleriochentrepren/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'rrbmaleriochentrepren/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'rrbmaleriochentrepren/quote-funnel' ),
...
$thanks = nps_page(
	'tack',
	'Tack',
	nps_pattern( 'rrbmaleriochentrepren/thank-you' ),
...
<p class="has-large-font-size">RRB måleri & entreprenad AB är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om RRB måleri & entreprenad AB', $about_content . "\n\n" . nps_pattern( 'rrbmaleriochentrepren/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'rrbmaleriochentrepren/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder RRB måleri & entreprenad AB uppgifterna du skickar med offertformuläret.' );
...
nps_log( 'RRB måleri & entreprenad AB demo ready.' );
