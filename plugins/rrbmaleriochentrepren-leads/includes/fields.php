...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'rrbmaleriochentrepren-leads' ),
				'storm'       => __( 'Storm or hail damage', 'rrbmaleriochentrepren-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'rrbmaleriochentrepren-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'rrbmaleriochentrepren-leads' ),
				'not-sure'    => __( 'Vet inte än', 'rrbmaleriochentrepren-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'rrbmaleriochentrepren-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'rrbmaleriochentrepren-leads' ),
				'research' => __( 'Jag kollar bara priser', 'rrbmaleriochentrepren-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'rrbmaleriochentrepren-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'rrbmaleriochentrepren-leads' ),
		'contacted' => __( 'Kontaktad', 'rrbmaleriochentrepren-leads' ),
		'quoted'    => __( 'Quote sent', 'rrbmaleriochentrepren-leads' ),
		'won'       => __( 'Won', 'rrbmaleriochentrepren-leads' ),
		'lost'      => __( 'Lost', 'rrbmaleriochentrepren-leads' ),
		'spam'      => __( 'Misstänkt spam', 'rrbmaleriochentrepren-leads' ),
	);
}
